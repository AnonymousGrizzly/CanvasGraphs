...
console.log(data4);
let Data3 = [1, 5, 7, 9, 8, 20, 62, 17, 70, 40, 30, 21, 15, 2, 53, 35, 61, 27, 1, 0];

let Data4chart = new PointChart({
    canvas: PointCanvas,
    seriesName: "Data overflow example",
    padding: 30,
    gridScale: 10,
    gridColor: "#242424",
    points_data: data4,
