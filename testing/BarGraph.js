...
let AmountOfTime = { "Mon": 12, "Tue": 10, "Wen": 14, "Thu": 2, "Fri": 12, "Sat": 6, "Sun": 8};
let Data2 = {"First": 68, "Second": 12, "Third": 9, "Forth": 43,  "Fifth": 32};


let AoTBarchart = new Barchart({
    canvas:BarCanvas,
    seriesName:"Amount of Time",
    padding:30,
    gridScale:2,
    gridColor:"#242424",
    bar_data:AmountOfTime,
    colors:["#a55ca5","#67b6c7", "#1db954","#eb9743", "#15bfa5", "#d64b53", "#fcdc6a"]
});

let Data2Barchart = new Barchart({
    canvas:BarCanvas,
    seriesName:"Title for graph",
    padding:30,
    gridScale:5,
    gridColor:"#242424",
    bar_data: Data2,
    colors:["#61afef", "#e44f26", "#1db954", "#fcdc6a", "#b03e45"]
});

AoTBarchart.draw();
AoTBarchart.drawLegend();